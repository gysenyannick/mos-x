      ...
      <div className="site-wrap" style={{ position: "relative", zIndex: 4 }}>
        ...
        <div className="flex justify-center" style={{ gap: "12px", flexWrap: "wrap" }}>
          <Link
            ...
            style={{ border: "none", color: "#FFFFFF", background: "#9BCB6C", borderRadius: "10px", padding: "14px 28px", fontFamily: "var(--font-montserrat), system-ui, sans-serif", fontWeight: 700, fontSize: "0.9375rem", textDecoration: "none", transition: "background-color 0.2s ease", gap: "8px" }}
          ...
          <a
            ...
            className="inline-flex items-center"
            style={{ border: "1px solid rgba(155,203,108,0.5)", color: "#FFFFFF", background: "transparent", borderRadius: "10px", padding: "14px 28px", fontFamily: "var(--font-montserrat), system-ui, sans-serif", fontWeight: 700, fontSize: "0.9375rem", textDecoration: "none", transition: "border-color 0.2s ease, color 0.2s ease", gap: "10px" }}
