      ...
      <section className="over-ons-mission-section" style={{ background: "#FFFFFF", padding: "80px 0" }}>
        <div className="site-wrap">
          <div className="over-ons-mission-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "center" }}>
            ...
            <BeforeAfterSlider beforeSrc="/images/Voor dakreiniging slider (2).png" afterSrc="/images/Na dakreiniging slider.png" beforePosition="center 30%" afterPosition="center 30%" style={{ boxShadow: "0 4px 32px rgba(0,0,0,0.10)" }} />
